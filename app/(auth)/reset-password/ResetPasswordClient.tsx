...
export default function ResetPasswordClient() {
    ...
    return (
      <div className="animate-fade-up text-center">
        ...
        <Link
          ...
          className="mt-5 inline-flex items-center gap-2 text-[13px] font-[700] hover:underline"
  ...
  return (
    <div className="animate-fade-up">
      ...
      <h1
        className="text-[22px] font-[800] tracking-tight"
        style={{ color: "var(--cm-text)" }}
      >
        Set new password
      </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label
            className="block text-[11.5px] font-[600]"
            style={{ color: "var(--cm-text2)" }}
          >
            New password
          </label>
      ...
      <Link
        href="/sign-in"
        className="mt-5 inline-flex items-center gap-1 text-[12.5px] font-[600] hover:underline"
        style={{ color: "var(--cm-blue)" }}
      >
        ← Back to sign in
      </Link>
